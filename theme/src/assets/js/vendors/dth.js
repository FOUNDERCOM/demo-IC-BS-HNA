    ...
    var featureViewer = {
        ...
        setMouseOver: function(v) {
            ...
            if (v) {
                ...
                this.screenSpaceEventHandler.setInputAction(this.onMouseMove, Cesium.ScreenSpaceEventType.MOUSE_MOVE);
            } else {
        ...
        setMouseClick: function(v) {
            ...
            if (v) {
                this.orginClickHandler = this.screenSpaceEventHandler.getInputAction(Cesium.ScreenSpaceEventType.LEFT_CLICK);
                this.screenSpaceEventHandler.setInputAction(this.onLeftClick, Cesium.ScreenSpaceEventType.LEFT_CLICK);
            } else {

                //设置为原来的
                this.screenSpaceEventHandler.setInputAction(this.orginClickHandler, Cesium.ScreenSpaceEventType.LEFT_CLICK);
            }
        },
        install: function(scene) {
            ...
            ol3d.container_.appendChild(nameOverlay); 
            ...
            this.onMouseMove = function(movement) {
                ...
                nameOverlay.style.bottom = scene._canvas.clientHeight - movement.endPosition.y + 'px';
            ...
            this.onLeftClick = function(movement) {
				...
				if(!tabDiv){
					...
					ol3d.container_.appendChild(tabDiv); 
					tabDiv.className = 'backdrop';
					tabDiv.style.display = 'block';
					tabDiv.style.position = 'absolute';
					tabDiv.style.top = '0';
					tabDiv.style.right = '0';
					tabDiv.style['pointer-events'] = 'none';
					tabDiv.style.padding = '4px';
